	...
	<header class="masthead bg-primary text-white text-center">
		<div class="container d-flex align-items-center flex-column">
			...
			<img class="masthead-avatar mb-5" src="assets/img/avataaars.svg"
				alt="..." />
			<!-- Masthead Heading-->
			<h1 class="masthead-heading text-uppercase mb-0">Welcome To Java Developer Team</h1>
			<!-- Icon Divider-->
			...
			<p class="masthead-subheading font-weight-light mb-0">Java
				Development - Web Development - Cybersecurity</p>
		</div>
	</header>
	<!-- Portfolio Section-->
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-lg-5 ms-auto">
					<p class="lead">My name is <%= session.getAttribute("name") %>, and I am a dedicated individual with a background in Computer Science Engineering from Lovely Professional University in Phagwara, Punjab. 
                        I am passionate about both web development and cybersecurity, aiming to blend programming expertise with ethical hacking skills.

                     In terms of my technical proficiency, I have a strong foundation in languages such as HTML, CSS, JavaScript, Bootstrap, java (with a focus on Object-Oriented Programming), MySQL, C++, Linux, Excel, and JSP. 
                     My commitment to continuous learning is reflected in my pursuit of certificates in Cloud Computing and Full Stack Web Development.</p>
				</div>
				<div class="col-lg-5 me-auto">
					<p class="lead">Outside of academics, I have actively participated in the National Cadet Corps (NCC), where I took on the role of a junior NCC commander, demonstrating leadership skills and a commitment to community service. 
					In response to pandemic situations, I contributed by providing essential supplies like food, clothes, and masks to those in need.
					
					While I am dedicated to honing my skills and furthering my career, it's important to note that I prioritize ethical practices in my work.
					 I believe in using my knowledge responsibly and ethically, ensuring the security and privacy of digital systems.</p>
				</div>
			</div>
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-4 mb-5 mb-lg-0">
					...
					<p class="lead mb-0">
						G-3 , NEST IN men's PG ,Western hills  <br /> Kukatpally, Hyderabad
					</p>
				</div>
				<!-- Footer Social Icons-->
				<div class="col-lg-4 mb-5 mb-lg-0">
				...
				<!-- Footer About Text-->
				<div class="col-lg-4">
					<h4 class="text-uppercase mb-4">About LinkedIn</h4>
					<p class="lead mb-0">
						I am ready to use my skills and achieve my goals no time <a href="https://www.linkedin.com/in/anjaneyulu-daddala-b10b1a23a/">Linked in </a> .
					</p>
				</div>
			</div>            
		</div>
